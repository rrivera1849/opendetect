...
| DNA-GPT | `dna-gpt` | Zero-shot | Truncate-then-regenerate BScore (Yang et al., 2023) |
| Revise-Detect | `revise-detect` | Zero-shot | Revise-then-score BARTScore similarity (Zhu et al., 2023) |
